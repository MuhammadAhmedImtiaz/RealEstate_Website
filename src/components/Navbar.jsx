...
export const Navbar = () => {
  ...
  <div className='absolute top-0 left-0 w-full z-10 flex'>
    <div className='container mx-auto  py-4 px-4 md:px-20 lg:px-32 bg-transparent flex space-x-7'>
    ...
    <img onClick={()=>setMobileMenu(false)}src={assets.cross_icon} className="w-6 "alt="" />
      ...
      <ul className='flex flex-col items-center gap-2 mt-5 px-5 text-lg font-medium '>
        ...
        <a onClick={()=>setMobileMenu(false)} href="#Testimonails" className='px-4 py-2 rounded-full inline-block'>Testimonails</a>
      </ul>
    </div>
    </div> 
  )
