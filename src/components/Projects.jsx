...
export const Projects = () => {
  ...
  return (
    <div className='mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden 'id='Projects'>
        ...
        <div className='overflow-hidden'>
            <div className='flex gap-8 trnasition-transform duration-500 ease-in-out'
